...
import MehidiInterviewMarks from './MehidiInterviewMarks';
import MehidiJobApply from './MehidiJobApply';
...
const MehidiAllMarks = () => {
    return (
        <div>
            <Box backgroundColor='#1F2937' mx='12' mb='10' mt='24' p={[4, 6]} boxShadow='2xl' rounded='md'>
            <Text textAlign={[ 'left', 'center' ]} fontWeight="bold" mb='40px' fontSize={32} color='#D3D4DA'>Mehidi Marks</Text>
            <SimpleGrid columns={[1, null, 2]} gap='40px' >
            
            <MehidiInterviewMarks></MehidiInterviewMarks>
            <MehidiJobApply></MehidiJobApply>
            </SimpleGrid>
